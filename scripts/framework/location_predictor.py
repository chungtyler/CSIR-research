class LocationPredictor:
    ...
    # Using given A* paths identify the routing of paths taking into consideration the person likley and distance to optimize exploration
    # Output the finalized list with score to each location
    pass
